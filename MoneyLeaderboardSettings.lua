return {
	DATA_STORE              = "TopMoney" , --< OrderedDataStore for leaderboard ranking (separate from PlayerData_V1)
	LEADERBOARD_UPDATE      = 1 , --< How often you want the leaderboard to update in minutes (no less than 1) 
	NAME_OF_STAT            = "Money" , --< Stat name to save in the database
	USE_LEADERSTATS         = true, --< Should use the Roblox built-in Leaderboard system too?
	NAME_LEADERSTATS        = "Money", --< What the name of the Leaderboard to use?
