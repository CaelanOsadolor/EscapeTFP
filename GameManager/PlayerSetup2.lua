...
local function setupPlayer(player)
	...
	-- STEP 10: Initialize wheel data for player
	print("[PlayerSetup] Initializing wheel for", player.Name)
	if data then
		WheelManager:InitializePlayer(player, data.WheelSpins or 0)
	else
		WheelManager:InitializePlayer(player, 0)
	end
