...
local REWARDS = {
	...
	{Name = "Valentine Pro Max", Type = "Item", ItemName = "Valentine Pro Max", Chance = 0.1}, -- Ultra rare Limited
}
...
local function giveItem(player, itemName)
	...
	if itemName == "RandomCelestial" then
		...
		local celestialItems = {
			{name = "iPhone 17 Pro", weight = 40},
			{name = "Samsung Z Flip", weight = 30},
			{name = "iPad Pro", weight = 20},
			{name = "iPhone 17 Pro Max", weight = 10},
		}
		...
		rarity = "Celestial"
	elseif itemName == "Valentine Pro Max" then
		rarity = "Limited"
	else
...
Players.PlayerRemoving:Connect(function(player)
	...
	-- Note: SaveManager's PlayerRemoving will handle the actual DataStore save
