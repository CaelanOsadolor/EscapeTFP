...
local REWARDS = {
	...
	{Name = "Love Ram", Type = "Item", ItemName = "Love Ram", Chance = 0.1}, -- Ultra rare Limited
}
...
local function giveItem(player, itemName)
	...
	if itemName == "RandomCelestial" then
		...
		local celestialItems = {
			{name = "Angel", weight = 40},
			{name = "Angry Deer", weight = 35},
			{name = "Snowman", weight = 25},
		}
