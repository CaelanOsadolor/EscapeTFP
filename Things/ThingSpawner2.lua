...
local THING_SPAWN_WEIGHTS = {
	-- Common Things (which common thing to spawn)
	Common = {
		["Bunny"] = 50,      -- Most common
		["Camper"] = 30,
		["Cook"] = 20        -- Least common
	},
	...
	-- Mythical Things
	Mythical = {
		["Assasin"] = 60,      -- Most common mythical
		["Koala kid"] = 30,
		["Kraken kid"] = 10    -- Rarest mythical (10%)
	},

	-- Divine Things
	Divine = {
		["Alien"] = 65,         -- Most common divine
		["Elite Alien"] = 25,
		["Squid kid"] = 10      -- Rarest divine (10%)
	},

	-- Secret Things
	Secret = {
		["Deer Monster"] = 65,          -- Most common secret
		["Angry Deer"] = 27.5,
		["Ram Monster"] = 7.5   -- Rarest secret (7.5%)
	},

	-- Celestial (spawns in Secret zone but very rarely)
	Celestial = {
		["Angel"] = 40,         -- Most common celestial
		["Snowman"] = 35,
		["Dark Deer"] = 25        -- Rarest celestial
	},

	-- Limited (doesn't spawn naturally, only through wheel/robux)
	Limited = {
		["Love Ram"] = 100      -- Only one Limited item
	}
}
		...
		if statsGui then
			...
			if frame then
				...
				if nameLabel and nameLabel:IsA("TextLabel") then
					...
					if template.Name == "Love Ram" then
