...
local THING_VALUES = {
	-- Common Things (6 items)
	["Black"] = 2,        -- $2/sec (cheapest)
	["Blue"] = 3,         -- $3/sec
	["Green"] = 4,        -- $4/sec
	["Pink"] = 5,         -- $5/sec
	["Red"] = 6,          -- $6/sec
	...
	-- Epic Things (4 items)
	["Fancy"] = 1000,     -- $1,000/sec
	["Icecream"] = 2000,  -- $2,000/sec
	["Knight"] = 3500,    -- $3,500/sec
	["Silver"] = 5000,    -- $5,000/sec

	-- Legendary Things (5 items)
	["Gold"] = 10000,     -- $10,000/sec
	["Scholar"] = 15000,  -- $15,000/sec
	["Sleepy"] = 22000,   -- $22,000/sec
	["Snowy"] = 30000,    -- $30,000/sec
	["TRex"] = 40000,     -- $40,000/sec

	-- Mythical Things (4 items)
	["Celebrity"] = 50000, -- $50,000/sec
	["Chubby"] = 65000,    -- $65,000/sec
	["Ruby"] = 80000,      -- $80,000/sec
	["Seal"] = 95000,      -- $95,000/sec

	-- Divine Things (5 items)
	["Astral"] = 200000,       -- $200,000/sec
	["Boxer"] = 250000,        -- $250,000/sec
	["Diamond"] = 300000,      -- $300,000/sec
	["Neon Samurai"] = 350000, -- $350,000/sec
	["Wizard"] = 400000,       -- $400,000/sec

	-- Secret Things (4 items)
	["Chill Bro"] = 670000, -- $670,000/sec
	["King"] = 777000,      -- $777,000/sec
	["Spino"] = 900000,     -- $900,000/sec
	["Yeti"] = 1000000,     -- $1,000,000/sec (best secret)

	-- Celestial (4 items)
	["Angel"] = 5000000,       -- 5M per second
	["Frostbite"] = 8000000,   -- 8M per second
	["HeartBreaker"] = 12000000, -- 12M per second
	["Space"] = 15000000,      -- 15M per second (best celestial)

	-- Limited (wheel/robux only)
	["Love Knight"] = 30000000, -- 30M per second (ultra rare)
}
...
function ThingValueManager.GetThingValue(thing)
	...
	-- Get mutation from attribute first (more reliable), then fallback to GUI
	local mutation = thing:GetAttribute("Mutation") or "None"
