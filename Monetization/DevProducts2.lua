...
DevProducts.Products = {
	...
	CashPack5 = {
		ProductId = 3538620746, -- 199 Robux
		Name = "Cash Pack #5",
	...
	SpeedTier1 = {
		ProductId = 3538600130, -- 18-50 speed (9 Robux)
	...
	SpeedTier2 = {
		ProductId = 3538600495, -- 51-100 speed (29 Robux)
	...
	SpeedTier3 = {
		ProductId = 3538607164, -- 101-150 speed (69 Robux)
	...
	SpeedTier4 = {
		ProductId = 3538601423, -- 151-200 speed (99 Robux)
	...
	SpeedTier5 = {
		ProductId = 3538602212, -- 201+ speed (129 Robux)
	...
	-- Pro Pack
	ProPack = {
		ProductId = 3538606882, -- 49 Robux
		Name = "Pro Pack",
		SpeedBoost = 50,
		Cash = 10000000, -- 10M
		Thing = "Deer", -- Secret Deer
		Rarity = "Secret",
		Type = "Pack"
	},
	...
	-- OP Pack
	OPPack = {
		ProductId = 3538606385, -- 79 Robux
		Name = "OP Pack",
		SpeedBoost = 100,
		Cash = 100000000, -- 100M
		Thing = "Owl", -- Secret Owl
		Rarity = "Secret",
		Type = "Pack"
	},
	-- Godspeed Tsunami Spawn (19 Robux)
	GodspeedSpawn = {
		ProductId = 3538605880, -- 19 Robux
		Name = "Godspeed Tsunami",
		Type = "GodspeedSpawn"
	},

	-- Love Ram (399 Robux) - Limited Rarity
	LoveRam = {
		ProductId = 3538617130, -- 399 Robux
		Name = "Love Ram",
		Thing = "Love Ram",
		Mutation = "",
		Rarity = "Limited",
