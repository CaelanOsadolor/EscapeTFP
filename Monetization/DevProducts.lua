...
DevProducts.Products = {
	...
	CashPack3 = {
		ProductId = 3515270770, -- 149 Robux
		Name = "Cash Pack #3",
	...
	CashPack4 = {
		ProductId = 3515272115, -- 349 Robux
		Name = "Cash Pack #4",
	...
	CashPack5 = {
		ProductId = 3515272703, -- 999 Robux
		Name = "Cash Pack #5",
	...
	SpeedTier1 = {
		ProductId = 3515277587, -- 18-50 speed (9 Robux)
	...
	SpeedTier2 = {
		ProductId = 3515278118, -- 51-100 speed (29 Robux)
	...
	SpeedTier3 = {
		ProductId = 3515278462, -- 101-150 speed (69 Robux)
	...
	SpeedTier4 = {
		ProductId = 3515278761, -- 151-200 speed (99 Robux)
	...
	SpeedTier5 = {
		ProductId = 3515279078, -- 201+ speed (129 Robux)
	...
	CarryUpgrade = {
		ProductId = 3515280018, -- Replace with actual product ID (29 R$)
		Name = "Carry Upgrade",
		Amount = 1, -- +1 carry
		Type = "CarryUpgrade"
	},
	...
	-- Pro Pack
	ProPack = {
		ProductId = 3515275327,
		Name = "Pro Pack",
		SpeedBoost = 50,
		Cash = 10000000, -- 10M
		Thing = "iPhone 13 Pro", -- Secret Deer
		Rarity = "Secret",
		Type = "Pack"
	},
	...
	-- OP Pack
	OPPack = {
		ProductId = 3515277319,
		Name = "OP Pack",
		SpeedBoost = 100,
		Cash = 100000000, -- 100M
		Thing = "Samsung S25 Ultra", -- Secret Owl
		Rarity = "Secret",
		Type = "Pack"
	},

	-- Godspeed Tsunami Spawn (99 Robux)
	GodspeedSpawn = {
		ProductId = 3515370630, -- Replace with actual product ID (99 R$)
		Name = "Godspeed Tsunami",
		Type = "GodspeedSpawn"
	},

	-- Valentine Pro Max (399 Robux)
	ValentineProMax = {
		ProductId = 3526936916, -- 399 Robux (same ProductId as old item)
		Name = "Valentine Pro Max",
		Thing = "Valentine Pro Max",
		Mutation = "",
		Rarity = "Limited",
		Type = "Thing"
	},

	-- Skip Rebirth Requirements (199 Robux)
	SkipRebirth = {
		ProductId = 3533850199, -- 199 Robux
		Name = "Skip Rebirth",
		Type = "SkipRebirth"
	},
...
function DevProducts:ProcessPurchase(player, productId)
	...
	elseif product.Type == "WheelSpins" then
		-- Give wheel spins
		...
		if WheelManager and WheelManager.AddSpins then
			...
			if notificationEvent then
				notificationEvent:FireClient(player, "You received " .. product.Amount .. " wheel spins!", true)
			end
			return true
		else
			warn("WheelManager not found")
			return false
		end
	...
	elseif product.Type == "GoldThing" then
		-- Give Gold Thing to inventory
		local ServerScriptService = game:GetService("ServerScriptService")
		local ThingInventoryManager = require(ServerScriptService.Things.ThingInventoryManager)
		local ThingValueManager = require(ServerScriptService.Things.ThingValueManager)
		local playSoundEvent = remoteEventsFolder and remoteEventsFolder:FindFirstChild("PlaySoundEvent")

		-- Get correct rate using ThingValueManager with Gold mutation
		local baseRate = ThingValueManager.GetThingValueByName(product.Thing, product.Rarity)
		local goldRate = baseRate * 1.5 -- Gold mutation is 1.5x

		-- AddToInventory handles: cloning from ServerStorage, removing TimerGui/ProximityPrompt,
		-- applying gold mutation colors, setting up GUI, and creating the Tool
		local success, message = ThingInventoryManager.AddToInventory(
			player,
			product.Thing,
			product.Mutation, -- "Gold"
			product.Rarity,
			goldRate,
			{}, -- Empty guiData - ThingInventoryManager will apply gold colors
			0 -- No upgrade level
		)
